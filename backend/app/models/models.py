...
class AuditoriaPDF(Base):
    ...
    fecha_dia = Column(Integer, nullable=False, index=True)
    fecha_mes = Column(Integer, nullable=False, index=True)
    fecha_anio = Column(Integer, nullable=False, index=True)
    turno = Column(String(20), nullable=False, index=True)
    linea = Column(String(50), nullable=True, index=True)
