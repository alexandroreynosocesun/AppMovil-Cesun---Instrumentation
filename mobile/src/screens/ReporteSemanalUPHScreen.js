              ...
              <View style={styles.podio}>
                ...
                {top3[1] && (
                  ...
                  >
                    ...
                    <Text style={styles.podioNombre} numberOfLines={2}>{n2(top3[1].nombre)}</Text>
                ...
                {top3[0] && (
                  ...
                  >
                    ...
                    <Text style={styles.podioNombre} numberOfLines={2}>{n2(top3[0].nombre)}</Text>
                ...
                {top3[2] && (
                  ...
                  >
                    ...
                    <Text style={styles.podioNombre} numberOfLines={2}>{n2(top3[2].nombre)}</Text>
            ...
            operadores.map((op) => (
              ...
              >
                ...
                <View style={styles.filaInfo}>
                  <Text style={styles.filaNombre}>{n2(op.nombre)}</Text>
