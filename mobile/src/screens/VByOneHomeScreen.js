...
export default function VByOneHomeScreen({ navigation }) {
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        ...
        >
          <View style={styles.header}>
            <Title style={styles.mainTitle}>VByOne / Mini LVDS / 2K LVDS</Title>
            <Paragraph style={styles.subtitle}>
              Gestión de VByOne, Mini LVDS y 2K LVDS
            </Paragraph>
          </View>
          ...
          <Button
            mode="contained"
            icon="qrcode-scan"
            onPress={() => navigation.navigate('QRScannerVByOne')}
          ...
          <View style={styles.buttonsContainer}>
            <Button
              mode="contained"
              icon="cable-data"
              onPress={() => navigation.navigate('ListVByOneCategory', { category: 'vbyone' })}
            ...
            <Button
              mode="contained"
              icon="cable-data"
              onPress={() => navigation.navigate('ListVByOneCategory', { category: 'mini_lvds' })}
              style={styles.categoryButton}
              contentStyle={styles.categoryButtonContent}
              labelStyle={styles.categoryButtonLabel}
              buttonColor="#4CAF50"
            ...
            <Button
              mode="contained"
              icon="cable-data"
              onPress={() => navigation.navigate('ListVByOneCategory', { category: 'lvds_2k' })}
              style={styles.categoryButton}
              contentStyle={styles.categoryButtonContent}
              labelStyle={styles.categoryButtonLabel}
              buttonColor="#2196F3"
